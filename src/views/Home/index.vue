...
import { dashOpt1, dashOpt2, mapOptions } from './options.ts';
...
const ranks = [
  ...
  { title: '电脑', value: 8000, percent: 70, color: '#00bcd4' },
  { title: '相机', value: 6000, percent: 60, color: '#64d572' },
  { title: '衣服', value: 5000, percent: 55, color: '#e9a745' },
  { title: '书籍', value: 4000, percent: 50, color: '#009688' },
];
...
.bg1 {
  background: linear-gradient(to bottom right, #2d8cf0, #1c4c8c);
}

.bg2 {
  background: linear-gradient(to bottom right, #64d572, #1d5e26);
}

.bg3 {
  background: linear-gradient(to bottom right, #f25e43, #812b1b);
}

.bg4 {
  background: linear-gradient(to bottom right, #e9a745, #86361a);
}
