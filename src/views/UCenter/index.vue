      ...
      <el-card class="user-profile" shadow="hover" :body-style="{ padding: '0px' }">
        ...
        <div class="user-info">
          ...
          <div class="info-desc">
            ...
            <el-link href="https://172.23.3.199:9999/zhangfei" target="_blank">Gitlab skyfeiz</el-link>
          </div>
          <div class="info-desc">工程技术中心</div>
          <div class="info-icon">
        ...
        <div class="user-footer">
          <div class="user-footer-item">
            <el-statistic title="Follower" :value="2024" />
          </div>
          <div class="user-footer-item">
            <el-statistic title="Following" :value="2024" />
          </div>
          <div class="user-footer-item">
            <el-statistic title="Total Post" :value="2024" />
          </div>
        </div>
      </el-card>
      <el-card
...
import TabsComp from '@/views/template/element/Tabs/index.vue';
